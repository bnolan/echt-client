...
export default class Settings extends React.Component {
  setUser (name) {
    ...
    AsyncStorage.setItem('@Echt:userName', name);
    AsyncStorage.setItem('@Echt:deviceKey', keys[name]);
    ...
    return (
      <View style={styles.userList}>
        <View style={styles.userButton}>
          <TouchableHighlight underlayColor='#ff00aa' onPress={(e) => this.setUser('ben')}>
            <Text style={styles.userText}>Become 👨 Ben</Text>
          </TouchableHighlight>
        </View>

        <View style={styles.userButton}>
          <TouchableHighlight underlayColor='#ff00aa' onPress={(e) => this.setUser('ingo')}>
